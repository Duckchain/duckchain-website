      ...
      <div>
        <ul>
          ...
          <li className="hover:bg-[rgba(253,184,51,0.20)] px-10 py-2 flex flex-col cursor-pointer hover:rounded-[5px] mx-[2px] hover:border-[rgba(239,207,36,0.2)] hover:border-[0.5px] rounded-[5px] border-transparent border-[0.5px]">
            ...
            <span className="text-[12px] text-[rgba(255,255,255,0.5)]">
              A decentralized exchange where you can swap and provide liquidity
            </span>
          </li>
          <li className="hover:bg-[rgba(253,184,51,0.20)] px-10 py-2 flex flex-col cursor-pointer hover:rounded-[5px] mx-[2px] hover:border-[rgba(239,207,36,0.2)] hover:border-[0.5px] rounded-[5px] border-transparent border-[0.5px]">
    ...
    <>
      ...
      <div>
        <ul>
          ...
          <li className="hover:bg-[rgba(253,184,51,0.20)] px-10 py-2 flex flex-col cursor-pointer hover:rounded-[5px] mx-[2px] hover:border-[rgba(239,207,36,0.2)] hover:border-[0.5px] rounded-[5px] border-transparent border-[0.5px]">
            <span className="text-[14px] font-[700]">GitHub Repository</span>
            <span className="text-[12px] text-[rgba(255,255,255,0.5)]">
              Checkout templates and packages for integrating or building on
              Duckchain
            </span>
          </li>
        </ul>
      ...
      <div>
        <ul>
          ...
          <li className="hover:bg-[rgba(253,184,51,0.20)] px-10 py-2 flex flex-col cursor-pointer hover:rounded-[5px] mx-[2px] hover:border-[rgba(239,207,36,0.2)] hover:border-[0.5px] rounded-[5px] border-transparent border-[0.5px]">
            ...
            <span className="text-[12px] text-[rgba(255,255,255,0.5)]">
              The latest news, product updates, thought Leadership and more from
              Duckchain
            </span>
          </li>
        </ul>
  ...
  return (
    <>
      ...
      <div>
        <ul>
          <li className="hover:bg-[rgba(253,184,51,0.20)] px-10 py-2 flex flex-col cursor-pointer hover:rounded-[5px] mx-[2px] hover:border-[rgba(239,207,36,0.2)] hover:border-[0.5px] rounded-[5px] border-transparent border-[0.5px]">
            <span className="text-[14px] font-[700]">Duckchain DPOS</span>
            <span className="text-[12px] text-[rgba(255,255,255,0.5)]">
              The native chain for Duckchain
            </span>
          </li>
          <li className="hover:bg-[rgba(253,184,51,0.20)] px-10 py-2 flex flex-col cursor-pointer hover:rounded-[5px] mx-[2px] hover:border-[rgba(239,207,36,0.2)] hover:border-[0.5px] rounded-[5px] border-transparent border-[0.5px]">
            <span className="text-[14px] font-[700]">BNB Duckchain DRC20</span>
            <span className="text-[12px] text-[rgba(255,255,255,0.5)]">
